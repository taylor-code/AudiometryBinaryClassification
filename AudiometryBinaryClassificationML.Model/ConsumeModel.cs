...
namespace AudiometryBinaryClassificationML.Model
{
    ...
    {
        private static readonly Lazy<PredictionEngine<HearingSetInput, HearingSetOutput>> PredictionEngine = new Lazy<PredictionEngine<HearingSetInput, HearingSetOutput>>(CreatePredictionEngine);
        ...
        {
            HearingSetOutput result = PredictionEngine.Value.Predict(input);
            return result;
        }
